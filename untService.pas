...

{
  ...
  - ir até a pasta do exe e executar
  ...
  Testando o serviço:
  - abrir os serviços do windows e "brincar" iniciando, pausando, reiniciando e parando o serviço
  os eventos serão observados no log em c:/
